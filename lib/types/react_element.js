...
ReactElement.prototype.getChildNodes = function () {
  ...
  if (!Array.isArray(this.nativeNode.props.children)) {
    this.nativeNode.props.children = [this.nativeNode.props.children];
  }
  ...
  for (var i = 0; i < this.nativeNode.props.children.length; i++) {
    if (this.nativeNode.props.children[i]) {
      if (typeof this.nativeNode.props.children[i] === "string") {
        children.push(new ReactText(this.nativeNode.props.children[i], this, i));
      } else {
        children.push(new ReactElement(this.nativeNode.props.children[i], this, i));
      }
    }
  }
...
ReactElement.prototype.getOwnerElement = function () {
