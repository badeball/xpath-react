...
function parseIntBase10(number) {
...
function find(element, expression) {
    const result = XPath.evaluate(expression, element, null, XPathResult.ANY_TYPE);
...
export { find, evaluate$Z as evaluate, createExpression, createNSResolver, XPathResult };
