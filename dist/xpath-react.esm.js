import XPathEvaluator, { ATTRIBUTE_NODE, TEXT_NODE, ELEMENT_NODE, DOCUMENT_NODE, XPathResult } from 'xpath-evaluator';
export { XPathResult } from 'xpath-evaluator';
...
export { find, evaluate, createExpression, createNSResolver };
